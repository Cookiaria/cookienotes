...
let tabs = JSON.parse(localStorage.getItem("tabs")) || [
    { 
        id: String(Date.now()), // Use a dynamic ID for the first tab
        name: "tab1", 
        content: localStorage.getItem("tab1") || "", 
        history: null, 
        previewState: false // Explicitly set previewState to false
    },
];

// Ensure all tabs have the previewState property
tabs = tabs.map(tab => ({
    ...tab,
